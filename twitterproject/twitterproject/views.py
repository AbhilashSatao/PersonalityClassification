...
def predicttwit(request):
   ...
   # username=input("Please Enter Twitter Account handle: ")
    ...
    #print(value)
    if value[0][0] == 1.0:
        answer.append("I=Introversion"+" ,")
    else:
        answer.append("E=Extroversion"+" ,")

    b = Counter(SN)
    value=b.most_common(1)
    #print(value)
    if value[0][0] == 1.0:
        answer.append("S=Sensing"+" ,")
    else:
        answer.append("N=Intuition"+" ,")
    #print(value)
    if value[0][0] == 1:
        answer.append("T=Thinking"+" ,")
    else:
        answer.append("F=Feeling"+" ,")

    b = Counter(PJ)
    value=b.most_common(1)
    #print(value)
    if value[0][0] == 1:
        answer.append("P=Perceiving"+" ,")
    else:
        answer.append("J=Judging"+" ,")
    mbti="".join(answer)
    print(mbti)
    if (mbti=="INFP"):
        print("I")
   ...
   # if os.path.exists("C:/Users/Abhi/Desktop/Twitter/user.csv"):
    ...
    return render(request,'output.html',{'data':mbti})